...
class jasonPlugin(PluginBase):
    ...
    def validate(self, configuration: Dict):
        ...
        if (
            ...
            self.logger.error(
                "jason Plugin: jason base URL must be a valid non-empty string."
            )
            return ValidationResult(
                success=False,
                message="jason base URL must be a valid non-empty string.",
            )
        ...
        if (
            ...
            self.logger.error(
                "jason Plugin: Application ID must be a valid non-empty string."
            )
            return ValidationResult(
                success=False,
        ...
        if (
            ...
            self.logger.error(
                "jason Plugin: Application Key must be a valid non-empty string."
            )
            return ValidationResult(
                success=False,
        ...
        if (
            ...
            self.logger.error(
                "jason Plugin: Access Key must be a valid non-empty string."
            )
            return ValidationResult(
                success=False,
        ...
        if (
            ...
            self.logger.error(
                "jason Plugin: Access Secret must be a valid non-empty string."
            )
            return ValidationResult(
                success=False,
        ...
        if "Awareness Training [1078]" not in packages:
            self.logger.error(
                "jason Plugin: 'Awareness Training' package is not enabled in "
